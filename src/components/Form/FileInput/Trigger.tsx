...
export function Trigger() {
  ...
  return (
    ...
    >
      <div className='rounded-full border-6 border-zinc-50 bg-zinc-100 p-2 group-hover:violet-50 group-hover:bg-violet-100 dark:border-zinc-700 dark:bg-zinc-800 dark:group-hover:border-zinc-600 dark:group-hover:bg-zinc-700'>
