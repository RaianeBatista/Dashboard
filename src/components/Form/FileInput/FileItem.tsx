...
import { formartBytes } from '@/utils/format-bytes';
...
const fileItem = tv({
  slots: {
    ...
    icon: 'rounded-full border-4 border-violet-200 bg-violet-200 p-2 text-violet-600 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-500',
    deleteButton: '',
  },
  ...
  variants: {
    state: {
      ...
      error: {
        ...
        deleteButton:
          'text-error-700 hover:text-error-700 dark:text-error-400 dark:hover:text-error-300',
      },
    },
  },
